module.exports = {
  siteTitle: 'Financeful',
  siteTitleAlt: 'Financeful Personal Finance', // This allows an alternative site title for SEO schema.
  publisher: 'Financeful', // Organization name used for SEO schema
  siteDescription:
    'A starter template to build amazing static websites with Gatsby, Contentful and Netlify',
  siteUrl: 'https://financeful.org', // Site domain. Do not include a trailing slash! If you wish to use a path prefix you can read more about that here: https://www.gatsbyjs.org/docs/path-prefix/
